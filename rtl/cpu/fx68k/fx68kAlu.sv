...
`define ALU_ROW_15		16'h8000
	...
	always_comb begin
		...
		// Column zero is the ALU-idle microcycle.  aluGetOp deliberately
		// produces no operation for it; retain the baseline CCR values above.
		// An explicit branch also keeps two-state simulators from treating the
		// idle encoding as an illegal active operation during reset.
		default: ;
