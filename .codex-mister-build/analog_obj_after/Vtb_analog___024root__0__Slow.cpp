...
VL_ATTR_COLD void Vtb_analog___024root___eval_static(Vtb_analog___024root* vlSelf) {
    ...
    // Body
    {
        ...
        vlSelfRef.tb_analog__DOT__pedal_button1 = 0U;
    }
...
#endif
            VL_FATAL_MT(".codex-mister-build/analog_obj_after\\tb_analog.sv", 3, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
...
VL_ATTR_COLD void Vtb_analog___024root___ctor_var_reset(Vtb_analog___024root* vlSelf) {
    ...
    vlSelf->tb_analog__DOT__i = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 1869477262552975535ull);
    ...
    vlSelf->tb_analog__DOT__pedal_out0 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 8349817380503964973ull);
    vlSelf->tb_analog__DOT__pedal_out1 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 16055691515377283878ull);
    vlSelf->tb_analog__DOT__pedal_out2 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 9410428442676404970ull);
    vlSelf->tb_analog__DOT__pedal_out3 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 8719451764343018679ull);
    ...
    vlSelf->tb_analog__DOT__wheel__DOT__speed_base = VL_SCOPED_RAND_RESET_I(6, __VscopeHash, 2508960903456882043ull);
    vlSelf->tb_analog__DOT__wheel__DOT__rough_rate = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 16106358080771862574ull);
    vlSelf->tb_analog__DOT__wheel__DOT__rough_rate_q = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 9648485758209298034ull);
    vlSelf->tb_analog__DOT__wheel__DOT__response_select = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 16421611550146503732ull);
    vlSelf->tb_analog__DOT__wheel__DOT__analog_sum = VL_SCOPED_RAND_RESET_I(17, __VscopeHash, 14696960969671860203ull);
    vlSelf->tb_analog__DOT__wheel__DOT__analog_remainder = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 15044553926621796234ull);
    vlSelf->tb_analog__DOT__wheel__DOT__analog_step = VL_SCOPED_RAND_RESET_I(7, __VscopeHash, 16224814069039694647ull);
    vlSelf->tb_analog__DOT__wheel__DOT__speed_code_q = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 5169539394868123040ull);
    vlSelf->tb_analog__DOT__wheel__DOT__response_code_q = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 13823650859179336110ull);
    ...
    vlSelf->tb_analog__DOT__upd__DOT__latch_x = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 5381708069990601635ull);
    vlSelf->tb_analog__DOT__upd__DOT__latch_y = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 9261533283388850927ull);
