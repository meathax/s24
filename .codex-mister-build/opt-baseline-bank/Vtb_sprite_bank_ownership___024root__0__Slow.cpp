...
#endif
            VL_FATAL_MT(".codex-mister-build/opt-baseline-bank\\tb_sprite_bank_ownership.sv", 8, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
