...
bool Vtb_sprite_bank_ownership___024root___eval_phase__inact(Vtb_sprite_bank_ownership___024root* vlSelf) {
    ...
    if (__VinactExecute) {
        VL_FATAL_MT(".codex-mister-build/opt-baseline-bank\\tb_sprite_bank_ownership.sv", 8, "", "ZERODLY: Design Verilated with '--no-sched-zero-delay', but #0 delay executed at runtime");
    }
...
#endif
            VL_FATAL_MT(".codex-mister-build/opt-baseline-bank\\tb_sprite_bank_ownership.sv", 8, "", "DIDNOTCONVERGE: NBA region did not converge after '--converge-limit' of 10000 tries");
        }
        __VnbaIterCount = ((IData)(1U) + __VnbaIterCount);
        vlSelfRef.__VinactIterCount = 0U;
        do {
            if (VL_UNLIKELY(((0x00002710U < vlSelfRef.__VinactIterCount)))) {
                VL_FATAL_MT(".codex-mister-build/opt-baseline-bank\\tb_sprite_bank_ownership.sv", 8, "", "DIDNOTCONVERGE: Inactive region did not converge after '--converge-limit' of 10000 tries");
            }
            ...
            do {
                if (VL_UNLIKELY(((0x00002710U < vlSelfRef.__VactIterCount)))) {
                    ...
                    Vtb_sprite_bank_ownership___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                    VL_FATAL_MT(".codex-mister-build/opt-baseline-bank\\tb_sprite_bank_ownership.sv", 8, "", "DIDNOTCONVERGE: Active region did not converge after '--converge-limit' of 10000 tries");
                }
