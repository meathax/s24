...
class alignas(VL_CACHE_LINE_BYTES) Vtb_sprite_bank_ownership___024root final {
  public:
    ...
    struct {
        ...
        CData/*7:0*/ tb_sprite_bank_ownership__DOT__dut__DOT__size_y_tiles;
    ...
    struct {
        ...
        SData/*9:0*/ tb_sprite_bank_ownership__DOT__dut__DOT__ydiv_adjust_value;
    ...
    struct {
        ...
        VlUnpacked<SData/*13:0*/, 256> tb_sprite_bank_ownership__DOT__dut__DOT__burst_cache_tag;
