...
#endif
            VL_FATAL_MT("C:/Users/meath/OneDrive/DOCUME~1/SEGASY~1/artifacts/verilator/sprite_bank_headless_baseline\\tb_sprite_bank_ownership.sv", 8, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
...
VL_ATTR_COLD void Vtb_sprite_bank_ownership___024root___ctor_var_reset(Vtb_sprite_bank_ownership___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->tb_sprite_bank_ownership__DOT__dut__DOT__burst_cache_tag[__Vi0] = VL_SCOPED_RAND_RESET_I(14, __VscopeHash, 17538375750693288802ull);
    }
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
    ...
    vlSelf->tb_sprite_bank_ownership__DOT__dut__DOT__size_y_tiles = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 7438402295594645067ull);
    ...
    vlSelf->tb_sprite_bank_ownership__DOT__dut__DOT__ydiv_adjust_value = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 14040227567582622441ull);
