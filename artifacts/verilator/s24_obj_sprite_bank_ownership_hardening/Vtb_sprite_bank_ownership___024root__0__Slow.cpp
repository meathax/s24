...
#endif
            VL_FATAL_MT("artifacts/verilator/s24_obj_sprite_bank_ownership_hardening\\tb_sprite_bank_ownership.sv", 8, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
